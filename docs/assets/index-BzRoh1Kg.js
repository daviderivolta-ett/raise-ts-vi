...
Andare nella sezione "Categorie" e sceglierne un'altra.`;break}}}customElements.define("page-around-me",dt);class B{constructor(e,t){a(this,"name");a(this,"pois");this.name=e,this.pois=t}static createEmpty(){return new B("",[])}}const L=class L{constructor(){a(this,"_customPath",new B("Percorso personalizzato",[]));if(L._instance)return L._instance;L._instance=this}static get instance(){return L._instance||(L._instance=new L),L._instance}get customPath(){return this._customPath}set customPath(e){this._customPath=e}addPoiToCustomPath(e){if(this.isPoiInCustomPath(e))return;const t={...this.customPath};t.pois.unshift(e),this.customPath={...t}}isPoiInCustomPath(e){return this.customPath.pois.some(t=>t.uuid===e.uuid)}saveCustomPath(){localStorage.setItem("custom-path-vi",JSON.stringify(this.customPath))}getSavedCustomPath(){const e=localStorage.getItem("custom-path-vi");if(!e)return;const t=JSON.parse(e);this._customPath=this.parsePath(t)}parsePath(e){let t=new B(e.name,e.pois);return t.pois=t.pois.map(s=>this.parsePoi(s)),t}parsePoi(e){let t=new P;switch(t.uuid=e.uuid,t.name=e.name,e.type){case h.LineString:e.type=d.LineString;break;case h.Polygon:e.type=d.Polygon;break;case h.MultiPoint:e.type=d.MultiPoint;break;case h.MultiLineString:e.type=d.MultiLineString;break;case h.MultiPolygon:e.type=d.MultiPolygon;break;default:e.type=d.Point;break}t.coordinates=e.coordinates,t.layerName=e.layerName;for(const s in e.props){if(typeof e.props[s]!="object")continue;let i=new J;switch(i.displayName=e.props[s].displayName,i.value=e.props[s].value,e.props[s].type){case"number":i.type=H.Number;break;case"image":i.type=H.Image;break;default:i.type=H.String;break}t.props.push(i)}return e.distance&&(t.distance=e.distance),t}};a(L,"_instance");let R=L;const x=class x{constructor(){x._instance||(x._instance=this)}static get instance(){return x._instance||(x._instance=new x),x._instance}calculateDistance(e,t){const s=e[0]-t[0],i=e[1]-t[1];return Math.sqrt(s*s+i*i)}nearestInsertion(e,t){const s=[...e];let i=0,n=this.calculateDistance(t,s[0].coordinates);for(let c=1;c<s.length;c++){const p=this.calculateDistance(t,s[c].coordinates);p<n&&(n=p,i=c)}const r=[s.splice(i,1)[0]];for(;s.length>0;){n=Number.MAX_VALUE;let c=0;for(let p=0;p<s.length;p++){const _=this.calculateDistance(r[r.length-1].coordinates,s[p].coordinates);_<n&&(n=_,c=p)}r.push(s.splice(c,1)[0])}return r.reverse()}};a(x,"_instance");let O=x;class ht extends HTMLElement{constructor(){super();a(this,"shadowRoot");a(this,"_poi",new P);a(this,"_position",0);this.shadowRoot=this.attachShadow({mode:"closed"})}get poi(){return this._poi}set poi(t){this._poi=t}get position(){return this._position}set position(t){this._position=t}connectedCallback(){this.render(),this.setup()}render(){var t;this.shadowRoot.innerHTML=`
