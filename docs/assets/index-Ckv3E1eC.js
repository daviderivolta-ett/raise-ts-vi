var K=Object.defineProperty;var Q=(r,e,t)=>e in r?K(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t;var n=(r,e,t)=>(Q(r,typeof e!="symbol"?e+"":e,t),t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const i of a)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function t(a){const i={};return a.integrity&&(i.integrity=a.integrity),a.referrerPolicy&&(i.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?i.credentials="include":a.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(a){if(a.ep)return;a.ep=!0;const i=t(a);fetch(a.href,i)}})();var R=(r=>(r.Default="default",r.Page="page",r.NotFound="not-found",r))(R||{});class I{constructor(e,t,s){n(this,"url");n(this,"type");n(this,"routing");this.url=e,this.type=t,this.routing=s}}class U{constructor(){n(this,"fontSize",14);n(this,"letterSpace",0);n(this,"lineHeight",1.15);n(this,"contrast","dark");n(this,"showSettings",!0)}}var f=(r=>(r.Light="light",r.Dark="dark",r.LightHigh="light-high",r.DarkHigh="dark-high",r))(f||{});const b=class b{constructor(){n(this,"_settings",new U);if(b._instance)return b._instance;b._instance=this}get settings(){return this._settings}set settings(e){this._settings=e,this.setFontSize(this.settings.fontSize),this.setLetterSpace(this.settings.letterSpace),this.setLineHeight(this.settings.lineHeight),this.setContrast(),this.setLocalStorageSettings()}static get instance(){return b._instance||(b._instance=new b),b._instance}getLocalStorageSettings(){const e=localStorage.getItem("settings-vi");if(!e)return;const t=JSON.parse(e),s=this.parseLocalStorageSettings(t);this.settings={...s}}setLocalStorageSettings(){localStorage.setItem("settings-vi",JSON.stringify(this.settings))}setLightContrast(){document.body.classList.remove("dark"),document.body.classList.remove("dark-high"),document.body.classList.remove("light-high"),document.body.classList.add("light")}setDarkContrast(){document.body.classList.remove("light"),document.body.classList.remove("light-high"),document.body.classList.remove("dark-high"),document.body.classList.add("dark")}setLightHighContrast(){document.body.classList.remove("light"),document.body.classList.remove("dark"),document.body.classList.remove("dark-high"),document.body.classList.add("light-high")}setDarkHighContrast(){document.body.classList.remove("light"),document.body.classList.remove("dark"),document.body.classList.remove("light-high"),document.body.classList.add("dark-high")}setFontSize(e){document.documentElement.style.setProperty("font-size",e.toString()+"px")}setContrast(){switch(this.settings.contrast){case f.Light:this.setLightContrast();break;case f.Dark:this.setDarkContrast();break;case f.LightHigh:this.setLightHighContrast();break;default:this.setDarkHighContrast();break}}setLetterSpace(e){document.documentElement.style.setProperty("letter-spacing",e.toString()+"rem")}setLineHeight(e){document.documentElement.style.setProperty("line-height",e.toString())}parseLocalStorageSettings(e){let t=new U;return t.contrast=e.contrast,t.fontSize=e.fontSize,t.lineHeight=e.lineHeight,t.letterSpace=e.letterSpace,t.showSettings=e.showSettings,t}};n(b,"_instance");let p=b;class F{constructor(e,t,s=2){n(this,"type");n(this,"message");n(this,"duration");this.type=e,this.message=t,this.duration=s}static createEmpty(){return new F("info","",2)}}var _=(r=>(r.Error="error",r.Info="info",r))(_||{});const v=class v{constructor(){n(this,"_snackbar",new F(_.Info,""));n(this,"_live",document.body.querySelector("app-snackbar"));if(v._instance)return v._instance;v._instance=this}static get instance(){return v._instance||(v._instance=new v),v._instance}get snackbar(){return this._snackbar}set snackbar(e){this._snackbar=e}get live(){return this._live}set live(e){this._live=e}updateSnackbar(e,t,s=5){this.live&&(this.live.snackbar=new F(e,t,s))}resetSnackbar(){this.live&&this.live.resetSnackbar()}};n(v,"_instance");let z=v;class Z extends HTMLElement{constructor(){super();n(this,"shadowRoot");n(this,"routes",[]);this.shadowRoot=this.attachShadow({mode:"closed"})}connectedCallback(){window.addEventListener("hashchange",()=>{this.checkRoute()})}addRoutes(t){this.routes=[...t],this.checkRoute()}checkRoute(){const t=window.location.hash.slice(2);this.changeRoute(t)}changeRoute(t){if(z.instance.resetSnackbar(),t){const s=this.routes.findIndex(a=>a.url===t);this.shadowRoot.innerHTML=this.routes[s]?this.routes[s].routing():this.sendNotFound()}else{this.checkParams(window.location.search);const s=this.routes.filter(a=>a.type===R.Default);s?window.location.hash="#/"+s[0].url:this.sendNotFound()}}sendNotFound(){const t=this.routes.filter(s=>s.type===R.NotFound);return t.length===0||(window.location.hash="#/"+t[0].url,this.changeRoute(t[0].url)),"404: Not found"}checkParams(t){const s=new URLSearchParams(t),a=new U;let i=!1;if(s.forEach(o=>{switch(i=!0,o){case"blind":a.showSettings=!1;break;case"vi":a.fontSize=24,a.contrast=f.DarkHigh;break;case"fine-motor":a.fontSize=24;break;case"color-blindness":a.contrast=f.DarkHigh;break}}),i){const o=window.location.pathname+window.location.hash;history.replaceState(null,"",o)}p.instance.settings={...a}}}customElements.define("app-router",Z);class tt extends HTMLElement{constructor(){super();n(this,"shadowRoot");this.shadowRoot=this.attachShadow({mode:"closed"})}connectedCallback(){this.render()}render(){this.shadowRoot.innerHTML=`
            ...
            `}setup(){this.addEventListener("click",()=>{this.dispatchEvent(new CustomEvent("tag-selected",{detail:{tag:this.tag}}))})}}customElements.define("app-tag-chip",Y);class et extends HTMLElement{constructor(){super();n(this,"shadowRoot");n(this,"_tags",[]);n(this,"_currentPageTags",[]);n(this,"_currentPage",0);n(this,"_tagsPerPage",8);n(this,"handleCheckbox",t=>{const s=t.target;this.dispatchEvent(new CustomEvent("tag-selected",{detail:{tag:s.tag}}))});this.shadowRoot=this.attachShadow({mode:"closed"})}get tags(){return this._tags}set tags(t){this._tags=t,this.connectedCallback()}get currentPageTags(){return this._currentPageTags}set currentPageTags(t){this._currentPageTags=t}get currentPage(){return this._currentPage}set currentPage(t){this._currentPage=t}get tagsPerPage(){return this._tagsPerPage}set tagsPerPage(t){this._tagsPerPage=t}connectedCallback(){this.render(),this.tags.length!==0&&(this.paginateTags(),this.setup())}render(){this.shadowRoot.innerHTML=`
...
out geom;`,s}createGeoJsonFromLayerWithGetUrl(e,t){let s=this.substituteRelevantProperties(e,t);return this.createFeatureAdditionalProperties(s,t)}createGeoJsonFromLayerWithPostUrl(e,t){const s={type:"FeatureCollection",features:[]};return e.elements.forEach(a=>{const i={},o=Object.keys(a.tags);switch(t.relevantProperties.filter(l=>o.includes(l.propertyName)).forEach(l=>{const m=l.propertyName;if(a.tags[m]){const V={propertyName:l.propertyName,displayName:l.displayName,type:l.type,value:a.tags[m]};i[m]=V}}),a.type){case"node":s.features.push(this.createGeoJsonPointFeature(a,i));break;case"way":a.nodes&&Array.isArray(a.nodes)&&(a.nodes[0]===a.nodes[a.nodes.length-1]?s.features.push(this.createGeoJsonPolygonFeature(a,i)):s.features.push(this.createGeoJsonLineStringFeature(a,i)));break;case"relation":a.members&&Array.isArray(a.members)&&a.members.forEach(l=>{l.type==="way"&&s.features.push(this.createGeoJsonLineStringFeature(l,i))});break}}),this.createFeatureAdditionalProperties(s,t)}createGeoJsonPointFeature(e,t){return{type:"Feature",properties:t,geometry:{type:"Point",coordinates:[e.lon,e.lat]}}}createGeoJsonPolygonFeature(e,t){return{type:"Feature",properties:t,geometry:{type:"Polygon",coordinates:[e.geometry.map(s=>[s.lon,s.lat])]}}}createGeoJsonLineStringFeature(e,t){return{type:"Feature",properties:t,geometry:{type:"LineString",coordinates:e.geometry.map(s=>[s.lon,s.lat])}}}substituteRelevantProperties(e,t){return e.features.forEach(s=>{const a={};for(const i in s.properties){const o=t.relevantProperties.find(c=>c.propertyName===i);if(o){const c={displayName:o.displayName,type:o.type,value:s.properties[i]};a[i]=c}}s.properties=a}),e}createFeatureAdditionalProperties(e,t){return e.features=e.features.map((s,a)=>(s.properties.name=t.name+" "+a,s.properties.layerName=t.id,s.properties.uuid=s.id?s.id:`${t.id}-${s.geometry.coordinates.toString()}`,s)),e}parseFeature(e){let t=X.createEmpty();return t.type=e.type,t.properties=e.properties,t.geometry_name=e.geometry_name,t.id=e.id,e.geometry&&(t.geometry=this.parseFeatureGeometry(e.geometry)),t}parseFeatureGeometry(e){let t=J.createEmpty();return t.type=this.parseFeatureGeometryType(e.type),t.coordinates=e.coordinates,t}parseFeatureGeometryType(e){let t=d.Point;switch(e){case"LineString":t=d.LineString;break;case"Polygon":t=d.Polygon;break;case"MultiPoint":t=d.MultiPoint;break;case"MultiLineString":t=d.MultiLineString;break;case"MultiPolygon":t=d.MultiPolygon;break}return t}async getPoisFromLayers(e){let t=[];const s=e.map(async i=>u.instance.createGeoJson(i));return(await Promise.all(s)).forEach(i=>{i.features.forEach(o=>t.push(y.fromFeature(o)))}),t=t.map(i=>{const o=e.find(c=>c.id===i.layerName);return o&&(i.layer=o),i}),t.filter(i=>!u.instance.isCoordinatesMultidimensional(i.coordinates))}isCoordinatesMultidimensional(e){if(!Array.isArray(e))return!1;for(let t=0;t<e.length;t++)if(Array.isArray(e[t]))return!0;return!1}orderPoisByDistance(e,t){return t.forEach(s=>{if(!u.instance.isCoordinatesMultidimensional(s.coordinates)){const a=Array.isArray(s.coordinates)?s.coordinates[1]:s.coordinates,i=Array.isArray(s.coordinates)?s.coordinates[0]:s.coordinates,o=this.haversineDistance(a,i,e.coords.latitude,e.coords.longitude);s.distance=o}}),t.sort((s,a)=>s.distance&&a.distance?s.distance-a.distance:0),t}haversineDistance(e,t,s,a){const i=e*Math.PI/180,o=s*Math.PI/180,l=(a-t)*Math.PI/180;return Math.acos(Math.sin(i)*Math.sin(o)+Math.cos(i)*Math.cos(o)*Math.cos(l))*6371e3}};n(u,"_instance");let G=u;const L=class L{constructor(){n(this,"_selectedPoi",new y);if(L._instance)return L._instance;L._instance=this}static get instance(){return L._instance||(L._instance=new L),L._instance}get selectedPoi(){return this._selectedPoi}set selectedPoi(e){this._selectedPoi=e,localStorage.setItem("selected-poi-vi",JSON.stringify(this.selectedPoi))}getSelectedPoi(){const e=localStorage.getItem("selected-poi-vi");if(!e)return;const t=JSON.parse(e);this._selectedPoi=this.parsePoi(t)}parsePoi(e){let t=new y;switch(t.uuid=e.uuid,t.name=e.name,e.type){case d.LineString:e.type=h.LineString;break;case d.Polygon:e.type=h.Polygon;break;case d.MultiPoint:e.type=h.MultiPoint;break;case d.MultiLineString:e.type=h.MultiLineString;break;case d.MultiPolygon:e.type=h.MultiPolygon;break;default:e.type=h.Point;break}t.coordinates=e.coordinates,t.layerName=e.layerName,t.layer=H.instance.parseLayer(e.layer);for(const s in e.props){if(typeof e.props[s]!="object")continue;let a=new O;switch(a.displayName=e.props[s].displayName,a.value=e.props[s].value,e.props[s].type){case"number":a.type=M.Number;break;case"image":a.type=M.Image;break;default:a.type=M.String;break}t.props.push(a)}return e.distance&&(t.distance=e.distance),t}};n(L,"_instance");let N=L;class at extends HTMLElement{constructor(){super();n(this,"shadowRoot");n(this,"_poi",new y);n(this,"_position",0);this.shadowRoot=this.attachShadow({mode:"closed"})}get poi(){return this._poi}set poi(t){this._poi=t}get position(){return this._position}set position(t){this._position=t}connectedCallback(){this.render(),this.setup()}render(){var t;this.shadowRoot.innerHTML=`
            ...
            `;const t=this.shadowRoot.querySelector("h1");t&&t.focus()}setup(){D.instance.subscribe("position-update",async t=>{if(console.log("position updated"),this._isLoading&&this.renderMsg("loading"),this._isLoading=!1,!t){this.renderMsg("error");return}let s=[];s=[...await G.instance.getPoisFromLayers(H.instance.activeLayers)],this.pois=[...G.instance.orderPoisByDistance(t,s)];const a=this.shadowRoot.querySelector(".message");a&&a.remove()})}update(){if(this.pois.length===0)return;const t=this.shadowRoot.querySelector(".message");t&&t.remove();const s=this.shadowRoot.querySelector(".around-you-features");s&&(s.innerHTML="",this.pois.forEach((a,i)=>{const o=document.createElement("app-poi-card");o.poi=a,o.position=i+1,s.append(o)}))}setupCards(){this.shadowRoot.querySelectorAll("app-poi-card").forEach(s=>{s.addEventListener("poi-selected",a=>{N.instance.selectedPoi=a.detail.selectedPoi,window.location.hash="/poi"})})}renderMsg(t){const s=this.shadowRoot.querySelector(".around-you-page");if(!s)return;const a=document.createElement("p");switch(t){case"loading":a.innerText="Caricamento...";break;case"error":a.innerText=`Impossibile trovare la tua posizione.
...
`).map(a=>{const i=a.split("	");return{path:i[0],layerName:i[1],id:i[2],name:i[3],latitude:i[4],longitude:i[5],height:i[6],info:i[7]}})}parseCsvPath(e){let t=C.createEmpty();return t.name=e[1].path,e.forEach((s,a)=>{a!==0&&t.pois.push(this.parseCsvPoi(s))}),t}parseCsvPoi(e){let t=new y;return t.layerName=e.layerName,t.name=e.name,t.coordinates=[parseFloat(e.longitude),parseFloat(e.latitude),parseFloat(e.height)],t.type=h.Point,t.uuid=e.id,t.props=this.parseCsvPoiProperties(e.info),t}parseCsvPoiProperties(e){let t=[];return e.split("|").forEach(a=>{let i=new O;i.displayName=a.split(":")[0],i.value=a.split(":")[1].trim(),i.type=M.String,t.push(i)}),t}getSuggestedPaths(e){let t=[];return this.suggestedPaths.forEach(s=>{s.pois.forEach(a=>{e.forEach(i=>{a.layerName===i.id&&t.push(s)})})}),[...new Set(t)]}getSelectedSuggestedPath(){const e=localStorage.getItem("selected-suggested-path-vi");if(!e)return;const t=JSON.parse(e);this._selectedSuggestedPath=this.parsePath(t)}};n(k,"_instance");let g=k;const E=class E{constructor(){E._instance||(E._instance=this)}static get instance(){return E._instance||(E._instance=new E),E._instance}calculateDistance(e,t){const s=e[0]-t[0],a=e[1]-t[1];return Math.sqrt(s*s+a*a)}nearestInsertion(e,t){const s=[...e];let a=0,i=this.calculateDistance(t,s[0].coordinates);for(let c=1;c<s.length;c++){const l=this.calculateDistance(t,s[c].coordinates);l<i&&(i=l,a=c)}const o=[s.splice(a,1)[0]];for(;s.length>0;){i=Number.MAX_VALUE;let c=0;for(let l=0;l<s.length;l++){const m=this.calculateDistance(o[o.length-1].coordinates,s[l].coordinates);m<i&&(i=m,c=l)}o.push(s.splice(c,1)[0])}return o.reverse()}};n(E,"_instance");let W=E;class nt extends HTMLElement{constructor(){super();n(this,"shadowRoot");n(this,"_poi",new y);n(this,"_position",0);this.shadowRoot=this.attachShadow({mode:"closed"})}get poi(){return this._poi}set poi(t){this._poi=t}get position(){return this._position}set position(t){this._position=t}connectedCallback(){this.render(),this.setup()}render(){var t;this.shadowRoot.innerHTML=`
            ...
            `}update(){const t=this.shadowRoot.querySelector(".suggested-paths-list");t&&(t.innerHTML="",this.paths.length===0&&t.append(this.renderEmptyMsg()),this.paths.forEach((s,a)=>{let i=document.createElement("app-suggested-path-card");i.path=s,i.position=a,t.append(i)}))}setupCardsBehaviour(){this.shadowRoot.querySelectorAll("app-suggested-path-card").forEach(s=>{s.addEventListener("suggested-path-selected",a=>{g.instance.selectedSuggestedPath=a.detail.selectedSuggestedPath,window.location.hash="/selected-suggested-path"})})}renderEmptyMsg(){const t=document.createElement("p");return t.innerHTML="Nessun percorso suggerito per il layer attivato al momento",t.classList.add("empty"),t}}customElements.define("page-suggested-paths",ct);class lt extends HTMLElement{constructor(){super();n(this,"shadowRoot");n(this,"_poi",new y);n(this,"_position",0);this.shadowRoot=this.attachShadow({mode:"closed"})}get poi(){return this._poi}set poi(t){this._poi=t}get position(){return this._position}set position(t){this._position=t}connectedCallback(){this.render(),this.setup()}render(){this.shadowRoot.innerHTML=`
