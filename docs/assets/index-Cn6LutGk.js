...
`).map(n=>{const r=n.split("	");return{path:r[0],layerName:r[1],id:r[2],name:r[3],latitude:r[4],longitude:r[5],height:r[6],info:r[7]}})}parseCsvPath(e){let t=R.createEmpty();return t.name=e[1].path,e.forEach((s,n)=>{n!==0&&t.pois.push(this.parseCsvPoi(s))}),t}parseCsvPoi(e){let t=new g;return t.layerName=e.layerName,t.name=e.name,t.coordinates=[parseFloat(e.longitude),parseFloat(e.latitude),parseFloat(e.height)],t.type=d.Point,t.uuid=e.id,t.props=this.parseCsvPoiProperties(e.info),t}parseCsvPoiProperties(e){let t=[];return e.split("|").forEach(n=>{let r=new $;r.displayName=n.split(":")[0],r.value=n.split(":")[1].trim(),r.type=k.String,t.push(r)}),t}getSuggestedPaths(e){let t=[];return this.suggestedPaths.forEach(s=>{s.pois.forEach(n=>{e.forEach(r=>{n.layerName===r.layer&&t.push(s)})})}),[...new Set(t)]}getSelectedSuggestedPath(){const e=localStorage.getItem("selected-suggested-path");if(!e)return;const t=JSON.parse(e);this._selectedSuggestedPath=this.parsePath(t)}};o(E,"_instance");let h=E;const S=class S{constructor(){S._instance||(S._instance=this)}static get instance(){return S._instance||(S._instance=new S),S._instance}calculateDistance(e,t){const s=e[0]-t[0],n=e[1]-t[1];return Math.sqrt(s*s+n*n)}nearestInsertion(e,t){const s=[...e];let n=0,r=this.calculateDistance(t,s[0].coordinates);for(let c=1;c<s.length;c++){const u=this.calculateDistance(t,s[c].coordinates);u<r&&(r=u,n=c)}const i=[s.splice(n,1)[0]];for(;s.length>0;){r=Number.MAX_VALUE;let c=0;for(let u=0;u<s.length;u++){const z=this.calculateDistance(i[i.length-1].coordinates,s[u].coordinates);z<r&&(r=z,c=u)}i.push(s.splice(c,1)[0])}return i.reverse()}};o(S,"_instance");let j=S;class nt extends HTMLElement{constructor(){super();o(this,"shadowRoot");o(this,"_poi",new g);this.shadowRoot=this.attachShadow({mode:"closed"})}get poi(){return this._poi}set poi(t){this._poi=t}connectedCallback(){this.render(),this.setup()}render(){this.shadowRoot.innerHTML=`
            ...
            `}update(){if(this.snackbar.message.length===0)return;const t=this.shadowRoot.querySelector(".snackbar-message");if(t){switch(t.innerHTML="",t.innerHTML=this.snackbar.message,this.snackbar.type){case x.Error:this.renderErrorSnackbar();break;default:this.renderInfoSnackbar();break}setTimeout(()=>this.resetSnackbar(),this.snackbar.duration*1e3)}}renderInfoSnackbar(){const t=this.shadowRoot.querySelector(".snackbar");t&&t.classList.add("info-snackbar")}renderErrorSnackbar(){const t=this.shadowRoot.querySelector(".snackbar");t&&t.classList.add("error-snackbar")}resetSnackbar(){const t=this.shadowRoot.querySelector(".snackbar-message"),s=this.shadowRoot.querySelector(".snackbar");t&&s&&(s.classList.remove("info-snackbar"),s.classList.remove("error-snackbar"))}}customElements.define("app-snackbar",yt);class bt extends HTMLButtonElement{constructor(){super()}connectedCallback(){this.setup()}setup(){this.addEventListener("click",()=>{const e=document.body.querySelector('dialog[is="app-menu"]');e&&e.showModal()})}}customElements.define("app-menu-btn",bt,{extends:"button"});M.instance.getLocalStorageSettings();h.instance.getSavedCustomPath();T.instance.getSavedLayers();const Pt=document.querySelector("app-router"),ft=new H("categories",v.Default,()=>"<page-categories />"),Et=new H("around-you",v.Page,()=>"<page-around-you />"),wt=new H("settings",v.Page,()=>"<page-settings />"),vt=new H("poi",v.Page,()=>"<page-poi />"),St=new H("custom-path",v.Page,()=>"<page-custom-path />"),Lt=new H("suggested-paths",v.Page,()=>"<page-suggested-paths />"),kt=new H("selected-suggested-path",v.Page,()=>"<page-selected-suggested-path />"),Rt=[ft,Et,wt,vt,St,Lt,kt];Pt.addRoutes(Rt);
