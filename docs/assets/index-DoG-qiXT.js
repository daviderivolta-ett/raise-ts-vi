var U=Object.defineProperty;var V=(o,t,e)=>t in o?U(o,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):o[t]=e;var a=(o,t,e)=>(V(o,typeof t!="symbol"?t+"":t,e),e);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function e(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(n){if(n.ep)return;n.ep=!0;const r=e(n);fetch(n.href,r)}})();var S=(o=>(o.Default="default",o.Page="page",o.NotFound="not-found",o))(S||{});class _{constructor(t,e,s){a(this,"url");a(this,"type");a(this,"routing");this.url=t,this.type=e,this.routing=s}}class T{constructor(t,e,s=2){a(this,"type");a(this,"message");a(this,"duration");this.type=t,this.message=e,this.duration=s}static createEmpty(){return new T("info","",2)}}var M=(o=>(o.Error="error",o.Info="info",o))(M||{});const y=class y{constructor(){a(this,"_snackbar",new T(M.Info,""));a(this,"_live",document.body.querySelector("app-snackbar"));if(y._instance)return y._instance;y._instance=this}static get instance(){return y._instance||(y._instance=new y),y._instance}get snackbar(){return this._snackbar}set snackbar(t){this._snackbar=t}get live(){return this._live}set live(t){this._live=t}updateSnackbar(t,e,s=5){this.live&&(this.live.snackbar=new T(t,e,s))}resetSnackbar(){this.live&&this.live.resetSnackbar()}};a(y,"_instance");let k=y;class W extends HTMLElement{constructor(){super();a(this,"shadowRoot");a(this,"routes",[]);this.shadowRoot=this.attachShadow({mode:"closed"})}connectedCallback(){window.addEventListener("hashchange",()=>{this.checkRoute()})}addRoutes(e){this.routes=[...e],this.checkRoute()}checkRoute(){const e=window.location.hash.slice(2);this.changeRoute(e)}changeRoute(e){if(k.instance.resetSnackbar(),e){const s=this.routes.findIndex(n=>n.url===e);this.shadowRoot.innerHTML=this.routes[s]?this.routes[s].routing():this.sendNotFound()}else{const s=this.routes.filter(n=>n.type===S.Default);s?window.location.hash="#/"+s[0].url:this.sendNotFound()}}sendNotFound(){const e=this.routes.filter(s=>s.type===S.NotFound);return e.length===0||(window.location.hash="#/"+e[0].url,this.changeRoute(e[0].url)),"404: Not found"}}customElements.define("app-router",W);class K extends HTMLElement{constructor(){super();a(this,"shadowRoot");this.shadowRoot=this.attachShadow({mode:"closed"})}connectedCallback(){this.render()}render(){this.shadowRoot.innerHTML=`
            ...
            `}}customElements.define("app-loader",K);class D{constructor(t,e){a(this,"color");a(this,"opacity");this.color=t,this.opacity=e}static createEmpty(){return new D("#008000",1)}}class B{constructor(t,e,s){a(this,"propertyName");a(this,"displayName");a(this,"type");this.propertyName=t,this.displayName=e,this.type=s}static createEmpty(){return new B("","","string")}}var C=(o=>(o.String="string",o.Image="image",o.Number="number",o))(C||{});class N{constructor(t,e,s,n,r,i){a(this,"name");a(this,"layer");a(this,"url");a(this,"style");a(this,"tags");a(this,"relevantProperties");this.name=t,this.layer=e,this.url=s,this.style=n,this.tags=r,this.relevantProperties=i}static createEmpty(){return new N("","","",D.createEmpty(),[],[B.createEmpty()])}}const b=class b{constructor(){a(this,"CATEGORIES_URL","./json/categories.json");a(this,"_data",{categories:[]});if(b._instance)return b._instance;b._instance=this}static get instance(){return b._instance||(b._instance=new b),b._instance}get data(){return this._data}set data(t){this._data=t}async getData(){if(this.data.categories.length!==0)return this._data;{let t=await this.fetchAppData(this.CATEGORIES_URL);return t=this.parseData(t),this.data=t,t}}async fetchAppData(t){try{const e=await fetch(t).then(n=>n.json()),s=await Promise.all(e.categories.map(async n=>{const r=await Promise.all(n.groups.map(async i=>{if(typeof i=="string")try{const c=await fetch(i);if(c.ok)return c.json();throw new Error("Errore durante il recupero dei dati.")}catch(c){return console.error(c),null}else return i}));return n.groups=r,n}));return{...e,categories:s}}catch(e){throw console.error("Errore durante il recupero dei dati JSON.",e),e}}parseData(t){return{categories:t.categories.map(s=>({name:s.name,groups:s.groups.map(n=>this.parseGroup(n))}))}}parseGroup(t){return Array.isArray(t)?t:{name:t.name,layers:t.layers.map(e=>this.parseLayer(e))}}parseLayer(t){return new N(t.name,t.layer,t.layer_url_wfs,new D(t.style.color,parseFloat(t.style.opacity)),t.tags,t.relevant_properties.map(e=>{let s=B.createEmpty();switch(s.displayName=e.display_name,s.propertyName=e.property_name,e.type){case"image":s.type=C.Image;break;case"number":s.type=C.Number;break;default:s.type=C.String;break}return s}))}getAllTags(t){let e=[];return t.categories.map(n=>{n.groups.map(r=>{typeof r!="string"&&r.layers.map(i=>{i.tags.map(c=>{e.push(c)})})})}),[...new Set(e)]}filterLayersByTags(t){let e=[];return t.forEach(n=>{this.filterLayersByTag(n).forEach(i=>e.push(i))}),[...new Set(e)]}filterLayersByTag(t){let e=[];return e=this.data.categories.flatMap(s=>s.groups.flatMap(n=>typeof n=="string"?[N.createEmpty()]:n.layers.filter(r=>r.tags.some(i=>i.includes(t))))),e}};a(b,"_instance");let I=b;const f=class f{constructor(){a(this,"_activeLayers",[]);if(f._instance)return f._instance;f._instance=this}static get instance(){return f._instance||(f._instance=new f),f._instance}get activeLayers(){return this._activeLayers}set activeLayers(t){this._activeLayers=t,localStorage.setItem("layers",JSON.stringify(this.activeLayers))}getSavedLayers(){const t=localStorage.getItem("layers");if(!t)return;const e=JSON.parse(t);let s=[];s=e.map(n=>this.parseLayer(n)),this._activeLayers=s}parseLayer(t){return new N(t.name,t.layer,t.url=t.url,new D(t.style.color,t.style.opacity),t.tags,t.relevantProperties.map(e=>{let s=B.createEmpty();switch(s.displayName=e.displayName,s.propertyName=e.propertyName,e.type){case"image":s.type=C.Image;break;case"number":s.type=C.Number;break;default:s.type=C.String;break}return s}))}};a(f,"_instance");let q=f;class X extends HTMLElement{constructor(){super();a(this,"shadowRoot");a(this,"_tag","");this.shadowRoot=this.attachShadow({mode:"closed"})}get tag(){return this._tag}set tag(e){this._tag=e}connectedCallback(){this.render(),this.setup()}render(){this.shadowRoot.innerHTML=`
            ...
            `;const e=this.shadowRoot.querySelector("h1");e&&e.focus()}setup(){const e=this.shadowRoot.querySelector("app-tags-wall");if(!e)return;let s=I.instance.getAllTags(I.instance.data);e.tags=s,e.addEventListener("tag-selected",n=>{q.instance.activeLayers=I.instance.filterLayersByTag(n.detail.tag),window.location.hash="/around-you"})}}customElements.define("page-categories",Z);const v=class v{constructor(){a(this,"_position",null);if(v._instance)return v._instance;v._instance=this}static get instance(){return v._instance||(v._instance=new v),v._instance}get position(){return this._position}set position(t){this._position=t}async getUserPosition(){try{return await new Promise((e,s)=>{navigator.geolocation.getCurrentPosition(n=>{e(n)},n=>{s(n)})})}catch(t){throw t}}};a(v,"_instance");let j=v;var l=(o=>(o.Point="Point",o.LineString="LineString",o.Polygon="Polygon",o.MultiPoint="MultiPoint",o.MultiLineString="MultiLineString",o.MultiPolygon="MultiPolygon",o))(l||{});class O{constructor(t,e){a(this,"type");a(this,"coordinates");this.type=t,this.coordinates=e}static createEmpty(){return new O("Point",[])}}class G{constructor(t,e,s,n,r){a(this,"type");a(this,"geometry");a(this,"properties");a(this,"id");a(this,"geometry_name");this.type=t,this.geometry=e,this.properties=s,this.id=n,this.geometry_name=r}static createEmpty(){return new G("",O.createEmpty(),{prop:""},"","")}}class m{constructor(){a(this,"uuid","");a(this,"name","");a(this,"type","Point");a(this,"coordinates",[]);a(this,"layerName","");a(this,"props",[]);a(this,"distance")}static fromFeature(t){const e=new m;switch(e.uuid=t.properties.uuid,e.name=t.properties.name,t.geometry.type){case l.LineString:e.type="LineString";break;case l.Polygon:e.type="Polygon";break;case l.MultiPoint:e.type="MultiPoint";break;case l.MultiLineString:e.type="MultiLineString";break;case l.MultiPolygon:e.type="MultiPolygon";break;default:e.type="Point";break}e.coordinates=t.geometry.coordinates,e.layerName=t.properties.layerName;for(const s in t.properties){if(typeof t.properties[s]!="object")continue;let n=new F;switch(n.displayName=t.properties[s].displayName,n.value=t.properties[s].value,t.properties[s].type){case"number":n.type="number";break;case"image":n.type="image";break;default:n.type="string";break}e.props.push(n)}return e}}var u=(o=>(o.Point="Point",o.LineString="LineString",o.Polygon="Polygon",o.MultiPoint="MultiPoint",o.MultiLineString="MultiLineString",o.MultiPolygon="MultiPolygon",o))(u||{});class F{constructor(){a(this,"displayName","");a(this,"type","string");a(this,"value","")}}var R=(o=>(o.String="string",o.Image="image",o.Number="number",o))(R||{});const h=class h{constructor(){if(h._instance)return h._instance;h._instance=this}static get instance(){return h._instance||(h._instance=new h),h._instance}async createGeoJson(t){const e=`${t.url}?service=WFS&typeName=${t.layer}&outputFormat=application/json&request=GetFeature&srsname=EPSG:4326`;let n=await(await fetch(e)).json(),r=this.substituteRelevantProperties(n,t),c={...this.createFeatureAdditionalProperties(r,t)};return c.features=c.features.slice(0,10),c.features=c.features.map(d=>this.parseFeature(d)),c}substituteRelevantProperties(t,e){return t.features.forEach(s=>{const n={};for(const r in s.properties){const i=e.relevantProperties.find(c=>c.propertyName===r);if(i){const c={displayName:i.displayName,type:i.type,value:s.properties[r]};n[r]=c}}s.properties=n}),t}createFeatureAdditionalProperties(t,e){return t.features=t.features.map((s,n)=>(s.properties.name=e.name+" "+n,s.properties.layerName=e.layer,s.properties.uuid=s.id,s)),t}parseFeature(t){let e=G.createEmpty();return e.type=t.type,e.properties=t.properties,e.geometry_name=t.geometry_name,e.id=t.id,t.geometry&&(e.geometry=this.parseFeatureGeometry(t.geometry)),e}parseFeatureGeometry(t){let e=O.createEmpty();return e.type=this.parseFeatureGeometryType(t.type),e.coordinates=t.coordinates,e}parseFeatureGeometryType(t){let e=l.Point;switch(t){case"LineString":e=l.LineString;break;case"Polygon":e=l.Polygon;break;case"MultiPoint":e=l.MultiPoint;break;case"MultiLineString":e=l.MultiLineString;break;case"MultiPolygon":e=l.MultiPolygon;break}return e}async getPoisFromLayers(t){let e=[];const s=t.map(async r=>h.instance.createGeoJson(r));return(await Promise.all(s)).forEach(r=>{r.features.forEach(i=>e.push(m.fromFeature(i)))}),e.filter(r=>!h.instance.isCoordinatesMultidimensional(r.coordinates))}isCoordinatesMultidimensional(t){if(!Array.isArray(t))return!1;for(let e=0;e<t.length;e++)if(Array.isArray(t[e]))return!0;return!1}orderPoisByDistance(t,e){return e.forEach(s=>{if(!h.instance.isCoordinatesMultidimensional(s.coordinates)){const n=Array.isArray(s.coordinates)?s.coordinates[1]:s.coordinates,r=Array.isArray(s.coordinates)?s.coordinates[0]:s.coordinates,i=this.haversineDistance(n,r,t.coords.latitude,t.coords.longitude);s.distance=i}}),e.sort((s,n)=>s.distance&&n.distance?s.distance-n.distance:0),e}haversineDistance(t,e,s,n){const r=t*Math.PI/180,i=s*Math.PI/180,d=(n-e)*Math.PI/180;return Math.acos(Math.sin(r)*Math.sin(i)+Math.cos(r)*Math.cos(i)*Math.cos(d))*6371e3}};a(h,"_instance");let $=h;const P=class P{constructor(){a(this,"_selectedPoi",new m);if(P._instance)return P._instance;P._instance=this}static get instance(){return P._instance||(P._instance=new P),P._instance}get selectedPoi(){return this._selectedPoi}set selectedPoi(t){this._selectedPoi=t,localStorage.setItem("selected-poi",JSON.stringify(this.selectedPoi))}getSelectedPoi(){const t=localStorage.getItem("selected-poi");if(!t)return;const e=JSON.parse(t);this._selectedPoi=this.parsePoi(e)}parsePoi(t){let e=new m;switch(e.uuid=t.uuid,e.name=t.name,t.type){case l.LineString:t.type=u.LineString;break;case l.Polygon:t.type=u.Polygon;break;case l.MultiPoint:t.type=u.MultiPoint;break;case l.MultiLineString:t.type=u.MultiLineString;break;case l.MultiPolygon:t.type=u.MultiPolygon;break;default:t.type=u.Point;break}e.coordinates=t.coordinates,e.layerName=t.layerName;for(const s in t.props){if(typeof t.props[s]!="object")continue;let n=new F;switch(n.displayName=t.props[s].displayName,n.value=t.props[s].value,t.props[s].type){case"number":n.type=R.Number;break;case"image":n.type=R.Image;break;default:n.type=R.String;break}e.props.push(n)}return t.distance&&(e.distance=t.distance),e}};a(P,"_instance");let H=P;class ee extends HTMLElement{constructor(){super();a(this,"shadowRoot");a(this,"_poi",new m);a(this,"_position",0);this.shadowRoot=this.attachShadow({mode:"closed"})}get poi(){return this._poi}set poi(e){this._poi=e}get position(){return this._position}set position(e){this._position=e}connectedCallback(){this.render(),this.setup()}render(){this.shadowRoot.innerHTML=`
            ...
            `}setup(){const e=this.shadowRoot.querySelector(".info-btn");e&&e.addEventListener("click",()=>{this.dispatchEvent(new CustomEvent("poi-selected",{detail:{selectedPoi:this.poi}}))})}}customElements.define("app-poi-card",ee);class te extends HTMLElement{constructor(){super();a(this,"shadowRoot");a(this,"_pois",[]);this.shadowRoot=this.attachShadow({mode:"closed"})}get pois(){return this._pois}set pois(e){this._pois=e}async connectedCallback(){const e=await j.instance.getUserPosition();k.instance.updateSnackbar(M.Info,"Caricamento..."),this.pois=await $.instance.getPoisFromLayers(q.instance.activeLayers),this.pois=$.instance.orderPoisByDistance(e,this.pois),this.render(),this.setup(),this.removeLoader(),k.instance.resetSnackbar()}render(){this.shadowRoot.innerHTML=`
...
`).map(n=>{const r=n.split("	");return{path:r[0],layerName:r[1],id:r[2],name:r[3],latitude:r[4],longitude:r[5],height:r[6],info:r[7]}})}parseCsvPath(t){let e=z.createEmpty();return e.name=t[1].path,t.forEach((s,n)=>{n!==0&&e.pois.push(this.parseCsvPoi(s))}),e}parseCsvPoi(t){let e=new m;return e.layerName=t.layerName,e.name=t.name,e.coordinates=[parseFloat(t.longitude),parseFloat(t.latitude),parseFloat(t.height)],e.type=u.Point,e.uuid=t.id,e.props=this.parseCsvPoiProperties(t.info),e}parseCsvPoiProperties(t){let e=[];return t.split("|").forEach(n=>{let r=new F;r.displayName=n.split(":")[0],r.value=n.split(":")[1].trim(),r.type=R.String,e.push(r)}),e}getSuggestedPaths(t){let e=[];return this.suggestedPaths.forEach(s=>{s.pois.forEach(n=>{t.forEach(r=>{n.layerName===r.layer&&e.push(s)})})}),[...new Set(e)]}getSelectedSuggestedPath(){const t=localStorage.getItem("selected-suggested-path");if(!t)return;const e=JSON.parse(t);this._selectedSuggestedPath=this.parsePath(e)}};a(w,"_instance");let g=w;const x=class x{constructor(){x._instance||(x._instance=this)}static get instance(){return x._instance||(x._instance=new x),x._instance}calculateDistance(t,e){const s=t[0]-e[0],n=t[1]-e[1];return Math.sqrt(s*s+n*n)}nearestInsertion(t,e){const s=[...t];let n=0,r=this.calculateDistance(e,s[0].coordinates);for(let c=1;c<s.length;c++){const d=this.calculateDistance(e,s[c].coordinates);d<r&&(r=d,n=c)}const i=[s.splice(n,1)[0]];for(;s.length>0;){r=Number.MAX_VALUE;let c=0;for(let d=0;d<s.length;d++){const A=this.calculateDistance(i[i.length-1].coordinates,s[d].coordinates);A<r&&(r=A,c=d)}i.push(s.splice(c,1)[0])}return i.reverse()}};a(x,"_instance");let J=x;class se extends HTMLElement{constructor(){super();a(this,"shadowRoot");a(this,"_poi",new m);a(this,"_position",0);this.shadowRoot=this.attachShadow({mode:"closed"})}get poi(){return this._poi}set poi(e){this._poi=e}get position(){return this._position}set position(e){this._position=e}connectedCallback(){this.render(),this.setup()}render(){this.shadowRoot.innerHTML=`
            ...
            `}setup(){this.setupPoiInfoBtn()}setupPoiInfoBtn(){const e=this.shadowRoot.querySelector(".path-info-btn");e&&e.addEventListener("click",()=>{this.dispatchEvent(new CustomEvent("suggested-path-selected",{detail:{selectedSuggestedPath:this.path}}))})}}customElements.define("app-suggested-path-card",re);class ae extends HTMLElement{constructor(){super();a(this,"shadowRoot");a(this,"_paths",[]);this.shadowRoot=this.attachShadow({mode:"closed"})}get paths(){return this._paths}set paths(e){this._paths=e,this.update(),this.setupCardsBehaviour()}async connectedCallback(){await g.instance.getCsvPaths(1),this.render(),this.paths=g.instance.getSuggestedPaths(q.instance.activeLayers)}render(){this.shadowRoot.innerHTML=`
            ...
            `;const e=this.shadowRoot.querySelector("h1");e&&e.focus()}setup(){const e=this.shadowRoot.querySelector("app-settings-contrast"),s=this.shadowRoot.querySelector("app-settings-font-size"),n=this.shadowRoot.querySelector("app-settings-letter-space"),r=this.shadowRoot.querySelector("app-settings-line-height");e&&s&&n&&r&&(e.contrast=this.settings.contrast,s.fontSize=this.settings.fontSize,r.lineHeight=this.settings.lineHeight,n.letterSpace=this.settings.letterSpace,e.addEventListener("contrast-updated",i=>{this.settings.contrast=i.detail.contrast,p.instance.settings.contrast=this.settings.contrast,p.instance.setContrast(),p.instance.settings=this.settings}),s.addEventListener("font-size-updated",i=>{this.settings.fontSize=i.detail.fontSize,p.instance.settings.fontSize=this.settings.fontSize,p.instance.setFontSize(this.settings.fontSize),p.instance.settings=this.settings}),n.addEventListener("letter-space-updated",i=>{this.settings.letterSpace=i.detail.letterSpace,p.instance.settings.letterSpace=this.settings.letterSpace,p.instance.setLetterSpace(this.settings.letterSpace),p.instance.settings=this.settings}),r.addEventListener("line-height-updated",i=>{this.settings.lineHeight=i.detail.lineHeight,p.instance.settings.lineHeight=this.settings.lineHeight,p.instance.setLineHeight(this.settings.lineHeight),p.instance.settings=this.settings}))}}customElements.define("page-settings",he);class ge extends HTMLElement{constructor(){super();a(this,"shadowRoot");a(this,"_snackbar",T.createEmpty());this.shadowRoot=this.attachShadow({mode:"closed"})}get snackbar(){return this._snackbar}set snackbar(e){this._snackbar=e,this.update()}connectedCallback(){this.render(),this.update()}render(){this.shadowRoot.innerHTML=`
            <div class="snackbar">
