var W=Object.defineProperty;var K=(o,e,t)=>e in o?W(o,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):o[e]=t;var r=(o,e,t)=>(K(o,typeof e!="symbol"?e+"":e,t),t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const a of n)if(a.type==="childList")for(const i of a.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function t(n){const a={};return n.integrity&&(a.integrity=n.integrity),n.referrerPolicy&&(a.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?a.credentials="include":n.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(n){if(n.ep)return;n.ep=!0;const a=t(n);fetch(n.href,a)}})();var L=(o=>(o.Default="default",o.Page="page",o.NotFound="not-found",o))(L||{});class _{constructor(e,t,s){r(this,"url");r(this,"type");r(this,"routing");this.url=e,this.type=t,this.routing=s}}class A{constructor(e,t,s=2){r(this,"type");r(this,"message");r(this,"duration");this.type=e,this.message=t,this.duration=s}static createEmpty(){return new A("info","",2)}}var x=(o=>(o.Error="error",o.Info="info",o))(x||{});const b=class b{constructor(){r(this,"_snackbar",new A(x.Info,""));r(this,"_live",document.body.querySelector("app-snackbar"));if(b._instance)return b._instance;b._instance=this}static get instance(){return b._instance||(b._instance=new b),b._instance}get snackbar(){return this._snackbar}set snackbar(e){this._snackbar=e}get live(){return this._live}set live(e){this._live=e}updateSnackbar(e,t,s=5){this.live&&(this.live.snackbar=new A(e,t,s))}resetSnackbar(){this.live&&this.live.resetSnackbar()}};r(b,"_instance");let m=b;class Q extends HTMLElement{constructor(){super();r(this,"shadowRoot");r(this,"routes",[]);this.shadowRoot=this.attachShadow({mode:"closed"})}connectedCallback(){window.addEventListener("hashchange",()=>{this.checkRoute()})}addRoutes(t){this.routes=[...t],this.checkRoute()}checkRoute(){const t=window.location.hash.slice(2);this.changeRoute(t)}changeRoute(t){if(m.instance.resetSnackbar(),t){const s=this.routes.findIndex(n=>n.url===t);this.shadowRoot.innerHTML=this.routes[s]?this.routes[s].routing():this.sendNotFound()}else{const s=this.routes.filter(n=>n.type===L.Default);s?window.location.hash="#/"+s[0].url:this.sendNotFound()}}sendNotFound(){const t=this.routes.filter(s=>s.type===L.NotFound);return t.length===0||(window.location.hash="#/"+t[0].url,this.changeRoute(t[0].url)),"404: Not found"}}customElements.define("app-router",Q);class X extends HTMLElement{constructor(){super();r(this,"shadowRoot");this.shadowRoot=this.attachShadow({mode:"closed"})}connectedCallback(){this.render()}render(){this.shadowRoot.innerHTML=`
            <div class="loader">
            ...
            `}setup(){this.addEventListener("click",()=>{this.dispatchEvent(new CustomEvent("tag-selected",{detail:{tag:this.tag}}))})}}customElements.define("app-tag-chip",U);class Z extends HTMLElement{constructor(){super();r(this,"shadowRoot");r(this,"_tags",[]);r(this,"_currentPageTags",[]);r(this,"_currentPage",0);r(this,"_tagsPerPage",8);r(this,"handleCheckbox",t=>{const s=t.target;this.dispatchEvent(new CustomEvent("tag-selected",{detail:{tag:s.tag}}))});this.shadowRoot=this.attachShadow({mode:"closed"})}get tags(){return this._tags}set tags(t){this._tags=t,this.connectedCallback()}get currentPageTags(){return this._currentPageTags}set currentPageTags(t){this._currentPageTags=t}get currentPage(){return this._currentPage}set currentPage(t){this._currentPage=t}get tagsPerPage(){return this._tagsPerPage}set tagsPerPage(t){this._tagsPerPage=t}connectedCallback(){this.render(),this.tags.length!==0&&(this.paginateTags(),this.setup())}render(){this.shadowRoot.innerHTML=`
            ...
            `}setup(){this.setupCloseBtn(),this.setupLinkBehaviour()}setupCloseBtn(){const e=this.querySelector("button");e&&e.addEventListener("click",()=>this.close())}setupLinkBehaviour(){const e=this.querySelectorAll("a");e&&e.forEach(t=>{t.addEventListener("click",s=>{s.preventDefault();const n=t.getAttribute("href");n&&(this.close(),window.location.hash=n)})})}}customElements.define("app-menu",et,{extends:"dialog"});class st extends HTMLElement{constructor(){super();r(this,"shadowRoot");r(this,"_poi",new y);r(this,"_position",0);this.shadowRoot=this.attachShadow({mode:"closed"})}get poi(){return this._poi}set poi(t){this._poi=t}get position(){return this._position}set position(t){this._position=t}connectedCallback(){this.render(),this.setup()}render(){this.shadowRoot.innerHTML=`
...
`).map(n=>{const a=n.split("	");return{path:a[0],layerName:a[1],id:a[2],name:a[3],latitude:a[4],longitude:a[5],height:a[6],info:a[7]}})}parseCsvPath(e){let t=M.createEmpty();return t.name=e[1].path,e.forEach((s,n)=>{n!==0&&t.pois.push(this.parseCsvPoi(s))}),t}parseCsvPoi(e){let t=new y;return t.layerName=e.layerName,t.name=e.name,t.coordinates=[parseFloat(e.longitude),parseFloat(e.latitude),parseFloat(e.height)],t.type=u.Point,t.uuid=e.id,t.props=this.parseCsvPoiProperties(e.info),t}parseCsvPoiProperties(e){let t=[];return e.split("|").forEach(n=>{let a=new F;a.displayName=n.split(":")[0],a.value=n.split(":")[1].trim(),a.type=z.String,t.push(a)}),t}getSuggestedPaths(e){let t=[];return this.suggestedPaths.forEach(s=>{s.pois.forEach(n=>{e.forEach(a=>{n.layerName===a.layer&&t.push(s)})})}),[...new Set(t)]}getSelectedSuggestedPath(){const e=localStorage.getItem("selected-suggested-path");if(!e)return;const t=JSON.parse(e);this._selectedSuggestedPath=this.parsePath(t)}};r(E,"_instance");let g=E;const k=class k{constructor(){k._instance||(k._instance=this)}static get instance(){return k._instance||(k._instance=new k),k._instance}calculateDistance(e,t){const s=e[0]-t[0],n=e[1]-t[1];return Math.sqrt(s*s+n*n)}nearestInsertion(e,t){const s=[...e];let n=0,a=this.calculateDistance(t,s[0].coordinates);for(let c=1;c<s.length;c++){const d=this.calculateDistance(t,s[c].coordinates);d<a&&(a=d,n=c)}const i=[s.splice(n,1)[0]];for(;s.length>0;){a=Number.MAX_VALUE;let c=0;for(let d=0;d<s.length;d++){const T=this.calculateDistance(i[i.length-1].coordinates,s[d].coordinates);T<a&&(a=T,c=d)}i.push(s.splice(c,1)[0])}return i.reverse()}};r(k,"_instance");let J=k;class at extends HTMLElement{constructor(){super();r(this,"shadowRoot");r(this,"_poi",new y);r(this,"_position",0);this.shadowRoot=this.attachShadow({mode:"closed"})}get poi(){return this._poi}set poi(t){this._poi=t}get position(){return this._position}set position(t){this._position=t}connectedCallback(){this.render(),this.setup()}render(){this.shadowRoot.innerHTML=`
            ...
            `}setup(){this.setupPoiInfoBtn()}setupPoiInfoBtn(){const t=this.shadowRoot.querySelector(".path-info-btn");t&&t.addEventListener("click",()=>{this.dispatchEvent(new CustomEvent("suggested-path-selected",{detail:{selectedSuggestedPath:this.path}}))})}}customElements.define("app-suggested-path-card",ot);class it extends HTMLElement{constructor(){super();r(this,"shadowRoot");r(this,"_paths",[]);this.shadowRoot=this.attachShadow({mode:"closed"})}get paths(){return this._paths}set paths(t){this._paths=t,this.update(),this.setupCardsBehaviour()}async connectedCallback(){await g.instance.getCsvPaths(1),this.render(),this.paths=g.instance.getSuggestedPaths(q.instance.activeLayers)}render(){this.shadowRoot.innerHTML=`
            ...
            `}update(){const t=this.shadowRoot.querySelector(".suggested-paths-list");t&&(t.innerHTML="",this.paths.length===0&&t.append(this.renderEmptyMsg()),this.paths.forEach((s,n)=>{let a=document.createElement("app-suggested-path-card");a.path=s,a.position=n,t.append(a)}))}setupCardsBehaviour(){this.shadowRoot.querySelectorAll("app-suggested-path-card").forEach(s=>{s.addEventListener("suggested-path-selected",n=>{g.instance.selectedSuggestedPath=n.detail.selectedSuggestedPath,window.location.hash="/selected-suggested-path"})})}renderEmptyMsg(){const t=document.createElement("p");return t.innerHTML="Nessun percorso suggerito per il layer attivato al momento",t}}customElements.define("page-suggested-paths",it);class ct extends HTMLElement{constructor(){super();r(this,"shadowRoot");r(this,"_poi",new y);r(this,"_position",0);this.shadowRoot=this.attachShadow({mode:"closed"})}get poi(){return this._poi}set poi(t){this._poi=t}get position(){return this._position}set position(t){this._position=t}connectedCallback(){this.render(),this.setup()}render(){this.shadowRoot.innerHTML=`
            ...
            `;const s=t.content;this.shadowRoot=this.attachShadow({mode:"closed"}),this.shadowRoot.appendChild(s.cloneNode(!0)),this.linkEl=this.shadowRoot.querySelector("a")}connectedCallback(){this.setup()}attributeChangedCallback(t,s,n){console.log(s),t==="href"&&this.linkEl&&this.linkEl.setAttribute("href",n)}setup(){this.linkEl&&this.linkEl.addEventListener("click",t=>{if(t.preventDefault(),!this.linkEl)return;const s=this.linkEl.getAttribute("href");s&&(window.location.hash=s)})}}r(V,"observedAttributes",["href"]);customElements.define("app-bar-el",V);class ft extends HTMLElement{constructor(){super();r(this,"shadowRoot");this.shadowRoot=this.attachShadow({mode:"closed"})}connectedCallback(){this.render(),this.setup()}render(){this.shadowRoot.innerHTML=`
            <nav class="menu" aria-label="menu">
                <ul class="menu-list">
                    <li><a href="/categories">Seleziona categoria</a></li>
                    <li><a href="/around-you">Intorno a me</a></li>
            ...
            `}setup(){this.setupLinkBehaviour()}setupLinkBehaviour(){const t=this.shadowRoot.querySelectorAll("a");t&&t.forEach(s=>{s.addEventListener("click",n=>{n.preventDefault();const a=s.getAttribute("href");a&&(window.location.hash=a)})})}}customElements.define("app-bar",ft);p.instance.getLocalStorageSettings();g.instance.getSavedCustomPath();q.instance.getSavedLayers();const vt=document.querySelector("app-router"),Pt=new _("categories",L.Default,()=>"<page-categories />"),wt=new _("around-you",L.Page,()=>"<page-around-you />"),Et=new _("settings",L.Page,()=>"<page-settings />"),St=new _("poi",L.Page,()=>"<page-poi />"),xt=new _("custom-path",L.Page,()=>"<page-custom-path />"),Lt=new _("suggested-paths",L.Page,()=>"<page-suggested-paths />"),kt=new _("selected-suggested-path",L.Page,()=>"<page-selected-suggested-path />"),Rt=[Pt,wt,Et,St,xt,Lt,kt];vt.addRoutes(Rt);
