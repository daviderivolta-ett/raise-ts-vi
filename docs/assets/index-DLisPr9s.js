var at=Object.defineProperty;var nt=(o,e,t)=>e in o?at(o,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):o[e]=t;var a=(o,e,t)=>(nt(o,typeof e!="symbol"?e+"":e,t),t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const n of i)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function t(i){const n={};return i.integrity&&(n.integrity=i.integrity),i.referrerPolicy&&(n.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?n.credentials="include":i.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(i){if(i.ep)return;i.ep=!0;const n=t(i);fetch(i.href,n)}})();var x=(o=>(o.Default="default",o.Page="page",o.NotFound="not-found",o))(x||{});class M{constructor(e,t,s){a(this,"url");a(this,"type");a(this,"routing");this.url=e,this.type=t,this.routing=s}}class ${constructor(){a(this,"fontSize",14);a(this,"letterSpace",0);a(this,"lineHeight",1.15);a(this,"contrast","dark");a(this,"showSettings",!0)}}var g=(o=>(o.Light="light",o.Dark="dark",o.LightHigh="light-high",o.DarkHigh="dark-high",o))(g||{});const m=class m{constructor(){a(this,"_settings",new $);if(m._instance)return m._instance;m._instance=this}get settings(){return this._settings}set settings(e){this._settings=e,this.setFontSize(this.settings.fontSize),this.setLetterSpace(this.settings.letterSpace),this.setLineHeight(this.settings.lineHeight),this.setContrast(),this.setLocalStorageSettings()}static get instance(){return m._instance||(m._instance=new m),m._instance}getLocalStorageSettings(){const e=localStorage.getItem("settings-vi");if(!e)return;const t=JSON.parse(e),s=this.parseLocalStorageSettings(t);this.settings={...s}}setLocalStorageSettings(){localStorage.setItem("settings-vi",JSON.stringify(this.settings))}setLightContrast(){document.body.classList.remove("dark"),document.body.classList.remove("dark-high"),document.body.classList.remove("light-high"),document.body.classList.add("light")}setDarkContrast(){document.body.classList.remove("light"),document.body.classList.remove("light-high"),document.body.classList.remove("dark-high"),document.body.classList.add("dark")}setLightHighContrast(){document.body.classList.remove("light"),document.body.classList.remove("dark"),document.body.classList.remove("dark-high"),document.body.classList.add("light-high")}setDarkHighContrast(){document.body.classList.remove("light"),document.body.classList.remove("dark"),document.body.classList.remove("light-high"),document.body.classList.add("dark-high")}setFontSize(e){document.documentElement.style.setProperty("font-size",e.toString()+"px")}setContrast(){switch(this.settings.contrast){case g.Light:this.setLightContrast();break;case g.Dark:this.setDarkContrast();break;case g.LightHigh:this.setLightHighContrast();break;default:this.setDarkHighContrast();break}}setLetterSpace(e){document.documentElement.style.setProperty("letter-spacing",e.toString()+"rem")}setLineHeight(e){document.documentElement.style.setProperty("line-height",e.toString())}parseLocalStorageSettings(e){let t=new $;return t.contrast=e.contrast,t.fontSize=e.fontSize,t.lineHeight=e.lineHeight,t.letterSpace=e.letterSpace,t.showSettings=e.showSettings,t}};a(m,"_instance");let l=m;class A{constructor(e,t,s=2){a(this,"type");a(this,"message");a(this,"duration");this.type=e,this.message=t,this.duration=s}static createEmpty(){return new A("info","",2)}}var z=(o=>(o.Error="error",o.Info="info",o))(z||{});const f=class f{constructor(){a(this,"_snackbar",new A(z.Info,""));a(this,"_live",document.body.querySelector("app-snackbar"));if(f._instance)return f._instance;f._instance=this}static get instance(){return f._instance||(f._instance=new f),f._instance}get snackbar(){return this._snackbar}set snackbar(e){this._snackbar=e}get live(){return this._live}set live(e){this._live=e}updateSnackbar(e,t,s=5){this.live&&(this.live.snackbar=new A(e,t,s))}resetSnackbar(){this.live&&this.live.resetSnackbar()}};a(f,"_instance");let P=f;class ot extends HTMLElement{constructor(){super();a(this,"shadowRoot");a(this,"routes",[]);this.shadowRoot=this.attachShadow({mode:"closed"})}connectedCallback(){window.addEventListener("hashchange",()=>{this.checkRoute()})}addRoutes(t){this.routes=[...t],this.checkRoute()}checkRoute(){const t=window.location.hash.slice(2)||"categories";this.changeRoute(t)}changeRoute(t){if(P.instance.resetSnackbar(),t){const s=t.split("?")[0],i=this.routes.findIndex(n=>n.url===s);this.shadowRoot.innerHTML=this.routes[i]?this.routes[i].routing():this.sendNotFound()}else{this.checkParams(window.location.search);const s=this.routes.filter(i=>i.type===x.Default);s?window.location.hash="#/"+s[0].url:this.sendNotFound()}}checkParams(t){const s=new URLSearchParams(t),i=new $;let n=!1;if(s.forEach(r=>{switch(n=!0,r){case"blind":i.showSettings=!1;break;case"vi":i.fontSize=24,i.contrast=g.DarkHigh;break;case"fine-motor":i.fontSize=24;break;case"color-blindness":i.contrast=g.DarkHigh;break}}),n){const r=window.location.pathname+window.location.hash;history.replaceState(null,"",r)}l.instance.settings={...i}}sendNotFound(){const t=this.routes.filter(s=>s.type===x.NotFound);return t.length===0||(window.location.hash="#/"+t[0].url,this.changeRoute(t[0].url)),"404: Not found"}}customElements.define("app-router",ot);const G=document.createElement("template");G.innerHTML=`
    <div class="loader">
    ...
    `;class rt extends HTMLElement{constructor(){super();a(this,"shadowRoot");this.shadowRoot=this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(G.content.cloneNode(!0)),this.shadowRoot.appendChild(W.cloneNode(!0))}}customElements.define("app-spinner-loader",rt);class O{constructor(e,t,s){a(this,"propertyName");a(this,"displayName");a(this,"type");this.propertyName=e,this.displayName=t,this.type=s}static createEmpty(){return new O("","","string")}}class q{constructor(){a(this,"id","");a(this,"name","");a(this,"url","");a(this,"method","get");a(this,"params",{});a(this,"tags",[]);a(this,"relevantProperties",[])}static createEmpty(){return{id:"",name:"",url:"",method:"get",params:{},tags:[],relevantProperties:[]}}}const y=class y{constructor(){a(this,"CATEGORIES_URL","./json/categories.json");a(this,"_data",{categories:[]});if(y._instance)return y._instance;y._instance=this}static get instance(){return y._instance||(y._instance=new y),y._instance}get data(){return this._data}set data(e){this._data=e}async getData(){if(this.data.categories.length!==0)return this._data;{let e=await this.fetchAppData(this.CATEGORIES_URL);return e=this.parseData(e),this.data=e,e}}async fetchAppData(e){try{const t=await fetch(e).then(i=>i.json()),s=await Promise.all(t.categories.map(async i=>{const n=await Promise.all(i.groups.map(async r=>{if(typeof r=="string")try{const c=await fetch(r);if(c.ok)return c.json();throw new Error("Errore durante il recupero dei dati.")}catch(c){return console.error(c),null}else return r}));return i.groups=n,i}));return{...t,categories:s}}catch(t){throw console.error("Errore durante il recupero dei dati JSON.",t),t}}parseData(e){return{categories:e.categories.map(s=>({name:s.name,groups:s.groups.map(i=>this.parseGroup(i))}))}}parseGroup(e){return Array.isArray(e)?e:{name:e.name,layers:e.layers.map(t=>this._parseLayer(t))}}_parseLayer(e){const t=q.createEmpty();return e.id&&(t.id=e.id),e.name&&(t.name=e.name),e.url&&(t.url=e.url),e.get&&(t.method="get",t.params={...e.get}),e.post&&(t.method="post",t.params={...e.post}),e.tags&&(t.tags=[...e.tags]),e.relevant_properties&&(t.relevantProperties=e.relevant_properties.map(s=>this._parseProperty(s))),t}_parseProperty(e){let t=O.createEmpty();return e.property_name&&(t.propertyName=e.property_name),e.display_name&&(t.displayName=e.display_name),e.type&&(t.type=e.type),t}getAllTags(e){let t=[];return e.categories.map(i=>{i.groups.map(n=>{typeof n!="string"&&n.layers.map(r=>{r.tags.map(c=>{t.push(c)})})})}),[...new Set(t)]}filterLayersByTags(e){let t=[];return e.forEach(i=>{this.filterLayersByTag(i).forEach(r=>t.push(r))}),[...new Set(t)]}filterLayersByTag(e){let t=[];return t=this.data.categories.flatMap(s=>s.groups.flatMap(i=>typeof i=="string"?[q.createEmpty()]:i.layers.filter(n=>n.tags.some(r=>r.includes(e))))),t}getLayerById(e){for(const t of this.data.categories)for(const s of t.groups){if(typeof s=="string")continue;const i=s.layers.find(n=>n.id===e);if(i)return i}}};a(y,"_instance");let C=y;class U extends HTMLElement{constructor(){super();a(this,"shadowRoot");a(this,"_tag","");this.shadowRoot=this.attachShadow({mode:"closed"})}get tag(){return this._tag}set tag(t){this._tag=t}connectedCallback(){this.render(),this.setup()}render(){this.shadowRoot.innerHTML=`
            ...
            `}setup(){this.addEventListener("click",()=>{this.dispatchEvent(new CustomEvent("tag-selected",{bubbles:!0,composed:!0,detail:{id:this.id}}))})}}customElements.define("app-tag-chip",U);const X=document.createElement("template");X.innerHTML=`
    ...
    `;class ct extends HTMLElement{constructor(){super();a(this,"shadowRoot");a(this,"_list");a(this,"_tags",[]);a(this,"_onTagSelected",t=>{const s=t;window.location.hash=`/layers?layer=${s.detail.id}`});this.shadowRoot=this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(X.content.cloneNode(!0)),this.shadowRoot.appendChild(Y.cloneNode(!0)),this._list=this.shadowRoot.querySelector("paginated-list")}set tags(t){this._tags=t,this._render()}async connectedCallback(){const t=await C.instance.getData();this.tags=C.instance.getAllTags(t).sort(),this._setup()}disconnectedCallback(){this.removeEventListener("tag-selected",this._onTagSelected)}_render(){this._tags.forEach(t=>{const s=new U;s.id=t,s.tag=t,this._list.appendChild(s)})}_setup(){this.addEventListener("tag-selected",this._onTagSelected)}}customElements.define("page-categories",ct);const b=class b{constructor(){a(this,"_activeLayers",[]);if(b._instance)return b._instance;b._instance=this}static get instance(){return b._instance||(b._instance=new b),b._instance}get activeLayers(){return this._activeLayers}set activeLayers(e){this._activeLayers=e,localStorage.setItem("layers-vi",JSON.stringify(this.activeLayers))}getSavedLayers(){const e=localStorage.getItem("layers-vi");if(!e)return;const t=JSON.parse(e);let s=[];s=t.map(i=>this.parseLayer(i)),this._activeLayers=s}parseLayer(e){const t=q.createEmpty();return e.id&&(t.id=e.id),e.name&&(t.name=e.name),e.url&&(t.url=e.url),e.method&&(t.method=e.method),e.params&&(t.params={...e.params}),e.tags&&(t.tags=[...e.tags]),e.relevantProperties&&(t.relevantProperties=e.relevantProperties),t}};a(b,"_instance");let I=b;const Q=document.createElement("template");Q.innerHTML=`
    ...
    `;class lt extends HTMLElement{constructor(){super();a(this,"shadowRoot");a(this,"_list");a(this,"_layers",[]);a(this,"_onTagSelected",t=>{const s=t,i=C.instance.getLayerById(s.detail.id);i&&(I.instance.activeLayers=[i]),window.location.hash="/around-me"});this.shadowRoot=this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(Q.content.cloneNode(!0)),this.shadowRoot.appendChild(K.cloneNode(!0)),this._list=this.shadowRoot.querySelector("paginated-list")}set layers(t){this._layers=t}async connectedCallback(){const t=window.location.hash.slice(2),i=new URLSearchParams(t.slice(t.indexOf("?"))).get("layer");if(!i){window.location.hash="/categories";return}await C.instance.getData(),this.layers=C.instance.filterLayersByTag(i).sort((n,r)=>n.name.localeCompare(r.name)),this._render(),this._setup()}disconnectedCallback(){this.removeEventListener("tag-selected",this._onTagSelected)}_render(){this._layers.forEach(t=>{const s=new U;s.id=t.id,s.tag=t.name,this._list.appendChild(s)})}_setup(){this.addEventListener("tag-selected",this._onTagSelected)}}customElements.define("page-layers",lt);const Z=document.createElement("template");Z.innerHTML=`
    ...
    `;class tt extends HTMLElement{constructor(){super();a(this,"shadowRoot");a(this,"_slot");a(this,"_slottedElements",[]);a(this,"_pagination");a(this,"_prevBtn");a(this,"_nextBtn");a(this,"_hasPagination",!1);a(this,"_pageElements",10);a(this,"_currentPage",0);this.shadowRoot=this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(Z.content.cloneNode(!0)),this.shadowRoot.appendChild(V.cloneNode(!0)),this._slot=this.shadowRoot.querySelector("slot"),this._pagination=this.shadowRoot.querySelector(".pagination"),this._prevBtn=this.shadowRoot.querySelector(".prev-btn"),this._nextBtn=this.shadowRoot.querySelector(".next-btn")}get hasPagination(){return this._hasPagination}set hasPagination(t){this._hasPagination=t}set pageElements(t){this._pageElements=t,this._checkPagination()}set currentPage(t){this._currentPage=t,this._changePage(t)}connectedCallback(){this._setup()}disconnectedCallback(){}attributeChangedCallback(t,s,i){t==="page-elements"&&i!==s&&(this.pageElements=parseInt(i)),t==="current-page"&&i!==s&&(parseInt(i)>=0&&parseInt(i)<=this._getPagesNumber()?this.currentPage=parseInt(i):parseInt(i)<0?this.setAttribute("current-page","0"):this.setAttribute("current-page",`${this._getPagesNumber()}`))}_setup(){this._slot.onslotchange=()=>this._onSlotChange(),this._prevBtn.onclick=()=>this._onPrevClick(),this._nextBtn.onclick=()=>this._onNextClick()}_onSlotChange(){this._checkPagination(),this._checkBtnStatus(),this._paginateElements(this._currentPage)}_onPrevClick(){this.setAttribute("current-page",JSON.stringify(this._currentPage-1))}_onNextClick(){this.setAttribute("current-page",JSON.stringify(this._currentPage+1))}_checkPagination(){this._slottedElements=this._slot.assignedElements(),this._slottedElements.length>=this._pageElements?this._pagination.classList.add("pagination--visible"):this._pagination.classList.remove("pagination--visible")}_changePage(t){this._checkBtnStatus(),this._paginateElements(t)}_getPagesNumber(){return Math.floor(this._slottedElements.length/this._pageElements)}_checkBtnStatus(){this._prevBtn.disabled=this._currentPage===0,this._nextBtn.disabled=this._currentPage===this._getPagesNumber()}_paginateElements(t){const s=t*this._pageElements,i=Math.min(s+this._pageElements,this._slottedElements.length);this._slottedElements.forEach(n=>{const r=n;r.style.display="none"});for(let n=s;n<i;n++){const r=this._slottedElements[n];r.style.display=""}}}a(tt,"observedAttributes",["page-elements","current-page"]);customElements.define("paginated-list",tt);var h=(o=>(o.Point="Point",o.LineString="LineString",o.Polygon="Polygon",o.MultiPoint="MultiPoint",o.MultiLineString="MultiLineString",o.MultiPolygon="MultiPolygon",o))(h||{});class _{constructor(){a(this,"uuid","");a(this,"name","");a(this,"type","Point");a(this,"coordinates",[]);a(this,"layer",q.createEmpty());a(this,"layerName","");a(this,"props",[]);a(this,"distance")}static fromFeature(e){const t=new _;switch(t.uuid=e.properties.uuid,t.name=e.properties.name,e.geometry.type){case h.LineString:t.type="LineString";break;case h.Polygon:t.type="Polygon";break;case h.MultiPoint:t.type="MultiPoint";break;case h.MultiLineString:t.type="MultiLineString";break;case h.MultiPolygon:t.type="MultiPolygon";break;default:t.type="Point";break}t.coordinates=e.geometry.coordinates,t.layerName=e.properties.layerName;for(const s in e.properties){if(typeof e.properties[s]!="object")continue;let i=new J;switch(i.displayName=e.properties[s].displayName,i.value=e.properties[s].value,e.properties[s].type){case"number":i.type="number";break;case"image":i.type="image";break;default:i.type="string";break}t.props.push(i)}return t}}var d=(o=>(o.Point="Point",o.LineString="LineString",o.Polygon="Polygon",o.MultiPoint="MultiPoint",o.MultiLineString="MultiLineString",o.MultiPolygon="MultiPolygon",o))(d||{});class J{constructor(){a(this,"displayName","");a(this,"type","string");a(this,"value","")}}var H=(o=>(o.String="string",o.Image="image",o.Number="number",o))(H||{});const u=class u{constructor(){if(u._instance)return u._instance;u._instance=this}static get instance(){return u._instance||(u._instance=new u),u._instance}async getPoisFromLayer(e){const t=await this.fetchLayerData(e);let s;return e.method==="get"&&(s=this._createGeoJsonFromLayerWithGetUrl(t,e)),e.method==="post"&&(s=this._createGeoJsonFromLayerWithPostUrl(t,e)),s.features.slice(0,20).map(i=>this._parseFeature(i,e)).filter(i=>i.type===d.Point)}_parseFeature(e,t){let s=new _;if(e.properties&&e.properties.uuid&&(s.uuid=e.properties.uuid),e.properties&&e.properties.customName&&(s.name=e.properties.customName),e.properties&&e.properties.layerId&&(s.layerName=e.properties.layerId),e.properties&&e.properties.props&&(s.props=[...e.properties.props]),s.layer=t,e.geometry)switch(e.geometry.type){case"Point":s.coordinates=e.geometry.coordinates,s.type=d.Point;break;case"LineString":s.coordinates=e.geometry.coordinates,s.type=d.LineString;break;case"Polygon":s.coordinates=e.geometry.coordinates,s.type=d.Polygon;break;default:console.warn(`Unsupported geometry type: ${e.geometry.type}`),s.type=d.Polygon}return s}async fetchLayerData(e){switch(e.method){case"get":const t=this._createGetUrl(e);try{const i=await fetch(t);if(i.ok)return await i.json();throw new Error("Errore nel recupero dei dati del layer")}catch{throw new Error("Errore nel recupero dei dati del layer")}case"post":const s=this._createPostQuery(e);try{const i=await fetch(e.url,{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({data:s}).toString()});if(i.ok)return await i.json();throw new Error("Errore nel recupero dei dati del layer")}catch{throw new Error("Errore nel recupero dei dati del layer")}}}_createGetUrl(e){const t=new Map(Object.entries(e.params)),s=Array.from(t,([n,r])=>[n,String(r)]),i=new URLSearchParams(s);return`${e.url}?${i.toString()}`}_createPostQuery(e){const t=[44.3654649485199,8.70205291300195,44.499460199499595,9.026271898848734];let s=`[out:json][timeout:20];
(
...
out geom;`,s}_createGeoJsonFromLayerWithGetUrl(e,t){let s={type:"FeatureCollection",features:[]};return e.features&&Array.isArray(e.features)&&(s.features=e.features.map((i,n)=>{let r={customName:i.properties.name?i.properties.name:`${t.name} ${n}`,layerId:t.id,uuid:this._createFeatureUuid(t.id,i),props:this._createFeatureProps(i.properties,t.relevantProperties)};return{...i,properties:r}})),s}_createFeatureUuid(e,t){const s=i=>i.toString().replace(/\D/g,"");switch(t.geometry.type){case"Point":const i=t.geometry.coordinates[0]+t.geometry.coordinates[1];return e+s(i);case"LineString":const n=t.geometry.coordinates[0][0]+t.geometry.coordinates[0][1];return e+s(n);case"Polygon":const r=t.geometry.coordinates[0][0][0]+t.geometry.coordinates[0][0][1];return e+s(r);case"MultiPoint":const c=t.geometry.coordinates[0][0]+t.geometry.coordinates[0][1];return e+s(c);case"MultiLineString":const p=t.geometry.coordinates[0][0][0]+t.geometry.coordinates[0][0][1];return e+s(p);case"MultiPolygon":const E=t.geometry.coordinates[0][0][0][0]+t.geometry.coordinates[0][0][0][1];return e+s(E);case"GeometryCollection":return e+this._createFeatureUuid(e,{type:"Feature",geometry:t.geometry.geometries[0]});default:return""}}_createFeatureProps(e,t){return Object.keys(e).map(s=>{const i=t.find(n=>n.propertyName===s);return i&&e[s]!==void 0&&e[s]!==null?{propertyName:i.propertyName,displayName:i.displayName,type:i.type,value:e[s]}:null}).filter(s=>s!==null)}_createGeoJsonFromLayerWithPostUrl(e,t){const s={type:"FeatureCollection",features:[]};for(const i of e.elements)switch(i.type){case"node":s.features.push(this._createGeoJsonPointFeature(i,t));break}return s}_createGeoJsonPointFeature(e,t){return{type:"Feature",properties:{customName:e.tags.name?e.tags.name:`${t.name}`,layerId:t.id,uuid:this._createFeatureUuid(t.id,{type:"Feature",properties:{},geometry:{type:"Point",coordinates:[e.lon,e.lat]}}),props:this._createFeatureProps(e.tags,t.relevantProperties)},geometry:{type:"Point",coordinates:[e.lon,e.lat]}}}orderPoisByDistance(e,t){return t.forEach(s=>{if(!u.instance.isCoordinatesMultidimensional(s.coordinates)){const i=Array.isArray(s.coordinates)?s.coordinates[1]:s.coordinates,n=Array.isArray(s.coordinates)?s.coordinates[0]:s.coordinates,r=this.haversineDistance(i,n,e.coords.latitude,e.coords.longitude);s.distance=r}}),t.sort((s,i)=>s.distance&&i.distance?s.distance-i.distance:0),t}isCoordinatesMultidimensional(e){if(!Array.isArray(e))return!1;for(let t=0;t<e.length;t++)if(Array.isArray(e[t]))return!0;return!1}haversineDistance(e,t,s,i){const n=e*Math.PI/180,r=s*Math.PI/180,p=(i-t)*Math.PI/180;return Math.acos(Math.sin(n)*Math.sin(r)+Math.cos(n)*Math.cos(r)*Math.cos(p))*6371e3}};a(u,"_instance");let T=u;const v=class v{constructor(){a(this,"_selectedPoi",new _);if(v._instance)return v._instance;v._instance=this}static get instance(){return v._instance||(v._instance=new v),v._instance}get selectedPoi(){return this._selectedPoi}set selectedPoi(e){this._selectedPoi=e,localStorage.setItem("selected-poi-vi",JSON.stringify(this.selectedPoi))}getSelectedPoi(){const e=localStorage.getItem("selected-poi-vi");if(!e)return;const t=JSON.parse(e);this._selectedPoi=this.parsePoi(t)}parsePoi(e){let t=new _;switch(t.uuid=e.uuid,t.name=e.name,e.type){case h.LineString:e.type=d.LineString;break;case h.Polygon:e.type=d.Polygon;break;case h.MultiPoint:e.type=d.MultiPoint;break;case h.MultiLineString:e.type=d.MultiLineString;break;case h.MultiPolygon:e.type=d.MultiPolygon;break;default:e.type=d.Point;break}t.coordinates=e.coordinates,t.layerName=e.layerName,t.layer=I.instance.parseLayer(e.layer);for(const s in e.props){if(typeof e.props[s]!="object")continue;let i=new J;switch(i.displayName=e.props[s].displayName,i.value=e.props[s].value,e.props[s].type){case"number":i.type=H.Number;break;case"image":i.type=H.Image;break;default:i.type=H.String;break}t.props.push(i)}return e.distance&&(t.distance=e.distance),t}};a(v,"_instance");let N=v;const w=class w{constructor(){a(this,"listeners",{});if(w._instance)return w._instance;w._instance=this}static get instance(){return w._instance||(w._instance=new w),w._instance}subscribe(e,t){this.listeners[e]||(this.listeners[e]=[]),this.listeners[e].push(t)}unsubscribe(e,t){this.listeners[e]&&(this.listeners[e]=this.listeners[e].filter(s=>s!==t))}unsubscribeAll(e){delete this.listeners[e]}publish(e,t){this.listeners[e]&&this.listeners[e].forEach(s=>s(t))}};a(w,"_instance");let F=w;const S=class S{constructor(){a(this,"_position",null);a(this,"_watchId",null);if(S._instance)return S._instance;S._instance=this}static get instance(){return S._instance||(S._instance=new S),S._instance}get position(){return this._position}set position(e){this._position=e,F.instance.publish("position-update",this.position)}get watchId(){return this._watchId}set watchId(e){this._watchId=e}async getUserPosition(){try{return await new Promise((t,s)=>{navigator.geolocation.getCurrentPosition(i=>{t(i)},i=>{s(i)},{timeout:5e3})})}catch(e){throw e}}async startWatchingPosition(){this.watchId=navigator.geolocation.watchPosition(e=>this.position=e,e=>{console.error(e),this.position=null},{enableHighAccuracy:!1,timeout:5e3,maximumAge:0})}stopWatchingPosition(){this.watchId&&(navigator.geolocation.clearWatch(this.watchId),this.watchId=null)}};a(S,"_instance");let D=S;class et extends HTMLElement{constructor(){super();a(this,"shadowRoot");a(this,"_poi",new _);a(this,"_position",0);this.shadowRoot=this.attachShadow({mode:"closed"})}get poi(){return this._poi}set poi(t){this._poi=t}get position(){return this._position}set position(t){this._position=t}connectedCallback(){this.render(),this.setup()}render(){var t;this.shadowRoot.innerHTML=`
            ...
            `}setup(){const t=this.shadowRoot.querySelector(".info-btn");t&&t.addEventListener("click",()=>{this.dispatchEvent(new CustomEvent("poi-selected",{composed:!0,bubbles:!0,detail:{selectedPoi:this.poi}}))})}}customElements.define("app-poi-card",et);const st=document.createElement("template");st.innerHTML=`
    ...
    `;const it=document.createElement("style");it.innerHTML=`
    h1,
    p {
        font-weight: 400;
        margin: 0;
    ...
    `;class dt extends HTMLElement{constructor(){super();a(this,"shadowRoot");a(this,"_heading");a(this,"_list");a(this,"_message");a(this,"_pois",[]);a(this,"_onPoiSelected",t=>{const s=t;N.instance.selectedPoi=s.detail.selectedPoi,window.location.hash="/poi"});this.shadowRoot=this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(st.content.cloneNode(!0)),this.shadowRoot.appendChild(it.cloneNode(!0)),this._heading=this.shadowRoot.querySelector(".title"),this._list=this.shadowRoot.querySelector(".around-you-features"),this._message=this.shadowRoot.querySelector(".message")}set pois(t){this._pois=t}async connectedCallback(){P.instance.updateSnackbar(z.Info,"Caricamento..."),this._updateMsg("loading");let t=null;try{t=await D.instance.getUserPosition();const s=await T.instance.getPoisFromLayer(I.instance.activeLayers[0]);this.pois=T.instance.orderPoisByDistance(t,s),this._pois.length===0&&this._updateMsg("empty")}catch{this._updateMsg("error")}finally{this._render(),this._setup(),this._pois.length!==0&&this._updateMsg(),P.instance.resetSnackbar()}}disconnectedCallback(){this.removeEventListener("poi-selected",this._onPoiSelected)}async _render(){this._heading.innerHTML=this._pois[0]?this._pois[0].layer.name:"Punti di interesse",this._list.innerHTML="",this._pois.forEach((t,s)=>{const i=new et;i.poi=t,i.position=s+1,this._list.appendChild(i)})}_setup(){this.addEventListener("poi-selected",this._onPoiSelected)}_updateMsg(t){switch(this._message.innerHTML="",t){case"loading":this._message.innerHTML="<app-spinner-loader />";break;case"error":this._message.innerText=`Impossibile trovare la tua posizione.
...
Andare nella sezione "Categorie" e sceglierne un'altra.`;break}}}customElements.define("page-around-me",dt);class B{constructor(e,t){a(this,"name");a(this,"pois");this.name=e,this.pois=t}static createEmpty(){return new B("",[])}}const L=class L{constructor(){a(this,"_customPath",new B("Percorso personalizzato",[]));if(L._instance)return L._instance;L._instance=this}static get instance(){return L._instance||(L._instance=new L),L._instance}get customPath(){return this._customPath}set customPath(e){this._customPath=e}addPoiToCustomPath(e){if(this.isPoiInCustomPath(e))return;const t={...this.customPath};t.pois.unshift(e),this.customPath={...t}}isPoiInCustomPath(e){return this.customPath.pois.some(t=>t.uuid===e.uuid)}saveCustomPath(){localStorage.setItem("custom-path-vi",JSON.stringify(this.customPath))}getSavedCustomPath(){const e=localStorage.getItem("custom-path-vi");if(!e)return;const t=JSON.parse(e);this._customPath=this.parsePath(t)}parsePath(e){let t=new B(e.name,e.pois);return t.pois=t.pois.map(s=>this.parsePoi(s)),t}parsePoi(e){let t=new _;switch(t.uuid=e.uuid,t.name=e.name,e.type){case h.LineString:e.type=d.LineString;break;case h.Polygon:e.type=d.Polygon;break;case h.MultiPoint:e.type=d.MultiPoint;break;case h.MultiLineString:e.type=d.MultiLineString;break;case h.MultiPolygon:e.type=d.MultiPolygon;break;default:e.type=d.Point;break}t.coordinates=e.coordinates,t.layerName=e.layerName;for(const s in e.props){if(typeof e.props[s]!="object")continue;let i=new J;switch(i.displayName=e.props[s].displayName,i.value=e.props[s].value,e.props[s].type){case"number":i.type=H.Number;break;case"image":i.type=H.Image;break;default:i.type=H.String;break}t.props.push(i)}return e.distance&&(t.distance=e.distance),t}};a(L,"_instance");let R=L;const k=class k{constructor(){k._instance||(k._instance=this)}static get instance(){return k._instance||(k._instance=new k),k._instance}calculateDistance(e,t){const s=e[0]-t[0],i=e[1]-t[1];return Math.sqrt(s*s+i*i)}nearestInsertion(e,t){const s=[...e];let i=0,n=this.calculateDistance(t,s[0].coordinates);for(let c=1;c<s.length;c++){const p=this.calculateDistance(t,s[c].coordinates);p<n&&(n=p,i=c)}const r=[s.splice(i,1)[0]];for(;s.length>0;){n=Number.MAX_VALUE;let c=0;for(let p=0;p<s.length;p++){const E=this.calculateDistance(r[r.length-1].coordinates,s[p].coordinates);E<n&&(n=E,c=p)}r.push(s.splice(c,1)[0])}return r.reverse()}};a(k,"_instance");let j=k;class ht extends HTMLElement{constructor(){super();a(this,"shadowRoot");a(this,"_poi",new _);a(this,"_position",0);this.shadowRoot=this.attachShadow({mode:"closed"})}get poi(){return this._poi}set poi(t){this._poi=t}get position(){return this._position}set position(t){this._position=t}connectedCallback(){this.render(),this.setup()}render(){var t;this.shadowRoot.innerHTML=`
            ...
            `;const t=this.shadowRoot.querySelector("h1");t&&t.focus()}setup(){this.setupSaveCustomPathBtn(),this.setupReorderPoisBtn()}update(){const t=this.shadowRoot.querySelector(".custom-path-list");t&&(t.innerHTML="",this.customPath.pois.length===0&&t.append(this.renderEmptyMsg()),this.customPath.pois.forEach((s,i)=>{let n=document.createElement("app-custom-path-card");n.poi=s,n.position=i+1,t.append(n)}))}setupSaveCustomPathBtn(){const t=this.shadowRoot.querySelector("#save-custom-path-btn");t&&t.addEventListener("click",()=>{R.instance.saveCustomPath(),P.instance.updateSnackbar(z.Info,"Percorso personalizzato salvato")})}setupReorderPoisBtn(){const t=this.shadowRoot.querySelector("#reorder-pois-btn");t&&t.addEventListener("click",async()=>{let s=await D.instance.getUserPosition();if(!s)return;const i=j.instance.nearestInsertion(this.customPath.pois,[s.coords.latitude,s.coords.longitude]);this.customPath={...this.customPath,pois:i},R.instance.customPath=this.customPath,P.instance.updateSnackbar(z.Info,`Tappe riordinate secondo il percorso ottimale. Ordine attuale: ${this.customPath.pois.map(n=>n.name).join(", ")}.`)})}setupCardsBeahviour(){this.shadowRoot.querySelectorAll("app-custom-path-card").forEach(s=>{s.addEventListener("poi-selected",i=>{N.instance.selectedPoi=i.detail.selectedPoi,window.location.hash="/poi"}),s.addEventListener("poi-deleted",i=>{let n=this.customPath.pois.filter(r=>r.uuid!==i.detail.deletedPoi.uuid);this.customPath={...this.customPath,pois:n},R.instance.customPath=this.customPath,P.instance.updateSnackbar(z.Info,`Tappa ${i.detail.deletedPoi.name} rimossa`)})})}renderEmptyMsg(){const t=document.createElement("p");return t.classList.add("empty-msg"),t.innerHTML="Nessuna tappa attualmente presente nel percorso personalizzato",t}}customElements.define("page-custom-path",pt);class ut extends HTMLElement{constructor(){super();a(this,"shadowRoot");a(this,"_poi",new _);this.shadowRoot=this.attachShadow({mode:"closed"})}get poi(){return this._poi}set poi(t){this._poi=t}connectedCallback(){N.instance.getSelectedPoi(),this.poi=N.instance.selectedPoi,console.log(this.poi),this.render(),this.setup()}render(){var s;this.shadowRoot.innerHTML=`
            <div class="poi-page">
                <div class="page-header">
            ...
            `}setup(){const t=this.shadowRoot.querySelector("button");t&&(t.onclick=()=>{localStorage.clear(),window.location.href="/"})}}customElements.define("app-home",St);Lt();async function Lt(){R.instance.getSavedCustomPath(),I.instance.getSavedLayers();const o=document.querySelector("app-router"),e=new M("categories",x.Default,()=>"<page-categories />"),t=new M("layers",x.Default,()=>"<page-layers />"),s=new M("around-you",x.Page,()=>"<page-around-you />"),i=new M("around-me",x.Page,()=>"<page-around-me />"),n=new M("settings",x.Page,()=>"<page-settings />"),r=new M("poi",x.Page,()=>"<page-poi />"),c=new M("custom-path",x.Page,()=>"<page-custom-path />"),p=[e,t,s,i,n,r,c];o.addRoutes(p),l.instance.getLocalStorageSettings();const E=document.querySelector("app-bar");E&&(E.showSettings=l.instance.settings.showSettings)}
